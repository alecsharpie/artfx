...
function App() {
  ...
  return (
    <div className="container">
      ...
      <Countdown />
      <CanvasGrid width={400} height={400} />
      <h3>How is it made?</h3>
      <ol>
        <li>Ask Wikipedia for the quote of the day</li>
        <li>
          Feed an AI (large language model (gpt-3.5-turbo)) the quote as
          inspiration along with 2 examples of the expected output.
        </li>
        <li>
      ...
      <ul>
        <li>Fun!</li>
        <li>Experimenting with reliable code generation.</li>
      </ul>
